...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2025 at 01:20 PM
...
--
-- Table structure for table `offline_cache`
--

CREATE TABLE `offline_cache` (
  `cache_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `data_type` enum('routine','product','content','recommendation','style') NOT NULL,
  `reference_id` int(11) NOT NULL,
  `cached_data` longtext DEFAULT NULL,
...
CREATE TABLE `user_favorites` (
  ...
  `user_id` int(11) NOT NULL,
  `favorited_type` enum('product','method','content','routine','style') DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `method_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `user_product_reviews`
--
...
--
-- Table structure for table `user_style_history`
--

CREATE TABLE `user_style_history` (
  `history_id` int(11) NOT NULL,
  `profile_id` int(11) NOT NULL,
  `style_id` int(11) NOT NULL,
  `installation_date` date NOT NULL,
  `removal_date` date DEFAULT NULL,
  `actual_longevity_days` int(11) DEFAULT NULL,
  `rating` int(11) DEFAULT NULL CHECK (`rating` between 1 and 5),
  `notes` text DEFAULT NULL,
  `would_repeat` tinyint(1) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `offline_cache`
--
ALTER TABLE `offline_cache`
  ADD PRIMARY KEY (`cache_id`),
  ADD KEY `idx_cache_user` (`user_id`),
  ADD KEY `idx_cache_type` (`data_type`,`reference_id`);
...
--
-- Indexes for table `user_product_reviews`
--
ALTER TABLE `user_product_reviews`
...
--
-- Indexes for table `user_style_history`
--
ALTER TABLE `user_style_history`
  ADD PRIMARY KEY (`history_id`),
  ADD KEY `idx_style_history_profile` (`profile_id`),
  ADD KEY `idx_style_history_style` (`style_id`);
...
--
-- AUTO_INCREMENT for table `offline_cache`
--
ALTER TABLE `offline_cache`
...
--
ALTER TABLE `routine_steps`
  MODIFY `step_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
-- AUTO_INCREMENT for table `user_product_reviews`
--
ALTER TABLE `user_product_reviews`
...
--
-- AUTO_INCREMENT for table `user_style_history`
--
ALTER TABLE `user_style_history`
...
--
-- Constraints for table `offline_cache`
--
ALTER TABLE `offline_cache`
  ADD CONSTRAINT `offline_cache_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
...
ALTER TABLE `user_favorites`
  ...
  ADD CONSTRAINT `user_favorites_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `user_favorites_ibfk_3` FOREIGN KEY (`method_id`) REFERENCES `growth_methods` (`method_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `user_favorites_ibfk_4` FOREIGN KEY (`content_id`) REFERENCES `educational_content` (`content_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `user_favorites_ibfk_5` FOREIGN KEY (`routine_id`) REFERENCES `hair_care_routines` (`routine_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `user_favorites_ibfk_6` FOREIGN KEY (`style_id`) REFERENCES `protective_styles` (`style_id`) ON DELETE SET NULL;
...
--
-- Constraints for table `user_product_reviews`
--
ALTER TABLE `user_product_reviews`
  ADD CONSTRAINT `user_product_reviews_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_product_reviews_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE;
...
--
-- Constraints for table `user_style_history`
--
ALTER TABLE `user_style_history`
  ADD CONSTRAINT `user_style_history_ibfk_1` FOREIGN KEY (`profile_id`) REFERENCES `user_hair_profiles` (`profile_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_style_history_ibfk_2` FOREIGN KEY (`style_id`) REFERENCES `protective_styles` (`style_id`) ON DELETE CASCADE;
COMMIT;
