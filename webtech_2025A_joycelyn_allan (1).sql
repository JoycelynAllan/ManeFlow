...
--
-- Host: localhost:3306
-- Generation Time: Dec 13, 2025 at 10:44 PM
...
(13, 7, '2026-01-13', 0.00, 0.17, 2, -30.00, 'Based on 2 data points. Average growth rate: -30.00 inches/month.', '2025-12-13 22:33:38'),
(14, 7, '2026-02-13', 0.00, 0.17, 2, -30.00, 'Based on 2 data points. Average growth rate: -30.00 inches/month.', '2025-12-13 22:33:38'),
(15, 7, '2026-03-13', 0.00, 0.17, 2, -30.00, 'Based on 2 data points. Average growth rate: -30.00 inches/month.', '2025-12-13 22:33:38'),
(16, 7, '2026-04-13', 0.00, 0.17, 2, -30.00, 'Based on 2 data points. Average growth rate: -30.00 inches/month.', '2025-12-13 22:33:38'),
(17, 7, '2026-05-13', 0.00, 0.17, 2, -30.00, 'Based on 2 data points. Average growth rate: -30.00 inches/month.', '2025-12-13 22:33:38'),
(18, 7, '2026-06-13', 0.00, 0.17, 2, -30.00, 'Based on 2 data points. Average growth rate: -30.00 inches/month.', '2025-12-13 22:33:38');
...
CREATE TABLE `growth_methods` (
  ...
  `method_name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `category` enum('protective_styling','scalp_care','nutrition','trimming','massage','treatment','lifestyle','hot_oil','deep_conditioning','inversion','supplements','other') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `hair_concerns` (
  ...
  `concern_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  `severity_level` enum('mild','moderate','severe') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `common_causes` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `offline_cache` (
  ...
  `data_type` enum('routine','product','content','recommendation','style') COLLATE utf8mb4_general_ci NOT NULL,
  `reference_id` int NOT NULL,
  `cached_data` longtext COLLATE utf8mb4_general_ci,
...
(3, 'joycelyn@gmail.com', '$2y$10$wnH/T/MsuUgORlHkZiXh7uDn7a0wx/XP0JLXbGYx.pB1Vc94SoHS2', 'Joycelyn', 'Allan', 'female', '2002-06-20', '2025-12-12 22:01:39', '2025-12-13 21:51:33', '2025-12-12 22:01:49', 1, 1, NULL, 'not_applicable', NULL, 0, NULL, 2, NULL),
...
CREATE TABLE `user_favorites` (
  ...
  `user_id` int NOT NULL,
  `favorited_type` enum('product','method','content','routine','style') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `product_id` int DEFAULT NULL,
  `method_id` int DEFAULT NULL,
...
(7, 7, 10, 'medium', 'low', 'dry', 21.00, 97.00, 'Odio cum aliquam con', 'low', 1, 0, 'Ipsam repudiandae op', NULL, NULL, '2025-12-13 21:53:01', '2025-12-13 22:33:34'),
...
CREATE TABLE `user_product_reviews` (
  ...
  `usage_duration` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `verified_purchase` tinyint(1) DEFAULT '0',
  `pros` text COLLATE utf8mb4_general_ci,
  `cons` text COLLATE utf8mb4_general_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ;
...
CREATE TABLE `user_style_history` (
  ...
  `actual_longevity_days` int DEFAULT NULL,
  `rating` int DEFAULT NULL,
  `notes` text COLLATE utf8mb4_general_ci,
...
--
ALTER TABLE `routine_steps`
  MODIFY `step_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;
...
--
ALTER TABLE `user_diagnoses`
  MODIFY `diagnosis_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `user_hair_concerns`
  MODIFY `user_concern_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=257;

--
-- AUTO_INCREMENT for table `user_hair_profiles`
--
ALTER TABLE `user_hair_profiles`
  MODIFY `profile_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `user_recommendations`
  MODIFY `recommendation_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=215;
